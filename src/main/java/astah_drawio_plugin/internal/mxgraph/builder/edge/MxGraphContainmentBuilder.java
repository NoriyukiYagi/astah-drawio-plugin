...
@GraphElementBuilder(astahTypes = "Containment")
public class MxGraphContainmentBuilder extends MxGraphEdgeBuilder {

	public MxGraphContainmentBuilder(ILinkPresentation link, MxGraphNodeBuilder source, MxGraphNodeBuilder target) {
		super(link, source, target);
		this.addStyle("html", "1");
		this.addStyle("startArrow", "circlePlus");
